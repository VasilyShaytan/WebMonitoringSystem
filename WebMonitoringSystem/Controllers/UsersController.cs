...
namespace WebMonitoringSystem.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(MonitoringSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserID,UserLogin,UserPassword,UserName,UserSurname,UserPhone,UserRole")] User user)
        {
