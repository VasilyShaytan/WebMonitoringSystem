...
namespace WebMonitoringSystem.Controllers
{
    public class RoutesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RouteID,VehicleID,CoordinateLatitude,CoordinateLongitude")] Route route)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RouteID,VehicleID,CoordinateLatitude,CoordinateLongitude")] Route route)
        {
            if (id != route.RouteID)
            {
                return NotFound();
